...
class Lista():
    ...
    def ordenar(self):
        if self.__comienzo == None or self.__comienzo.siguiente is None:
            return
        else:
            lista=[]
            actual = self.__comienzo
            while actual:
                lista.append(actual.objeto)
                actual = actual.siguiente
            lista.sort()
            self.__comienzo = Nodo(lista[0])
            actual = self.__comienzo
            for dato in lista[1:]:
    ...
    def inciso_2(self):
        ...
        while actual:
            print(actual.objeto)
            total_recaudado += actual.objeto.costo_total()
            actual = actual.siguiente
