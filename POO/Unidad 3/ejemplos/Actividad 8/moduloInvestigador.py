...
class investigador(personal):
   ...
   def __init__(self, cuil, apellido, nombre, sueldoBasico, antiguedad, areaInvestigacion = None, tipoInvestigacion = None, carrera = None, cargo = None, catedra = None, porcentaje = -1):
